...
return {
  {
    ...
    config = function()
      ...
      map("n", "<leader>dr", dap.repl.open, vim.tbl_extend("force", opts, { desc = "Open REPL" }))
      ...
      end, vim.tbl_extend("force", opts, { desc = "Quit and reset" }))
      map("n", "<leader>du", dapui.toggle, vim.tbl_extend("force", opts, { desc = "Toggle DAP UI" }))
      map({ "n", "v" }, "<leader>de", dapui.eval, vim.tbl_extend("force", opts, { desc = "Evaluate expression" }))
